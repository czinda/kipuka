...
//!
//! RFC 9148 §5.4 defines Content-Format option values that map EST HTTP
...
/// `application/pkcs7-mime; smime-type=server-generated` (RFC 9148 §10.1, TBD280).
///
...
/// `application/pkcs7-mime; smime-type=certs-only` (RFC 9148 §10.1, TBD281).
///
...
/// `application/pkcs8` (RFC 9148 §10.1, TBD286).
///
...
/// `application/csrattrs` (RFC 9148 §10.1, TBD287).
///
...
/// # RFC Reference
///
/// RFC 9148 §5.4, Table 2: Content-Format ID to media type mapping.
...
/// # RFC Reference
///
/// RFC 9148 §5.4, Table 2: media type to Content-Format ID mapping.
